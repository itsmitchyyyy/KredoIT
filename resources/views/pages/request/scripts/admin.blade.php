        ...
        function fillUpTBody(res, attribute){
            if(attribute == 'request') {
                ...
                return `<tr>
                        ...
                        <td>
                            <button class="btn btn-success" onclick="updatePurchase(`+res.id+`, 'overdue')">
                                Overdue
                            </button>
                            <button class="btn btn-danger" onclick="updatePurchase(`+res.id+`, 'returned')">
                                Returned
                            </button>
                        </td>
                        </tr>`;
        ...
        function getHistory(){
            ...
            $.ajax({
                ...
                result.map(function(res){
                    if(res.user != null && res.item_request_status == 'using')
                    options += fillUpTBody(res, 'history');
                });
